  ...
  return (
    <nav className="bg-gray-800 shadow-md p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className={`lg:flex ${isMenuOpen ? "block" : "hidden"} space-x-4`}>
          {isLoggedIn ? (
            <>
              ...
              <Link to="/create-project" className="text-gray-300 hover:text-blue-400 transition">
                Create Project
              </Link>
              <Link to="/explore" className="text-gray-300 hover:text-blue-400 transition">
                Explore
              </Link>
              <button
            ...
            <>
              <Link to="/signup" className="text-gray-300 hover:text-blue-400 transition">
                Sign Up
              </Link>
